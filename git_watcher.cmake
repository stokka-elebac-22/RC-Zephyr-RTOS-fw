...
function(GetGitState _working_dir)
    ...
    # Get output of git rev parse
    RunGitCommand(rev-parse --short=8 ${object})
    if(NOT exit_code EQUAL 0)
        set(ENV{GIT_DESCRIBE_HEX} "unknown")
    else()
        set(ENV{GIT_DESCRIBE_HEX} "0x${output}")
    endif()
